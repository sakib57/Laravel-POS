      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
            ...
            <div class="tile-body">
                <form action="{{ url('products/process_import') }}" method="post">
                    @csrf
                    ...
                    <input type="hidden" name="product_code" value="{{ $product_code_db }}">
                        ...
                        <div class="form-group">
                            <div class="form-control">
                                    <button class="btn btn-primary" type="submit" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Import Product</button>
                            </div>
                        </div>
                        <table class="table table-hover table-bordered" id="sampleTable">
                        <thead>
                            <tr>
                                @foreach (config('app.import_fields_product') as $field)    
                                    <th>{{ $field }}</th>
                                @endforeach
                            </tr>  
                        </thead>
