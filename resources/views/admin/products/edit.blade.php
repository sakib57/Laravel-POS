...
<main class="app-content">
        ...
        <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="tile">
                          <h3 class="tile-title">Update New Product Here</h3>
                          <div class="tile-body">
                                  ...
                                  <div class="col-md-8">
                                    <select name="fk_category_id" id="fk_category_id" class="form-control select2" >
                                      ...
                                      @foreach ($categories as $category)
                                          <option value="{{ $category->id }}" {{ $category->id == $product->fk_category_id ? 'selected':'' }} onchange="getSubcategories($category->id)">{{ $category->category_name }}</option>
                                      @endforeach
                                    </select>
                                    <div class="text-danger">
                            ...
                            <div class="form-group row">
                                  ...
                                  <div class="col-md-8">
                                  <input name="product_unit" value="{{ $product->product_unit }}"  class="form-control" type="number" placeholder="Product Unit">
                                  <div class="text-danger">
                            ...
                            <div class="form-group row">
                                  ...
                                  <div class="col-md-8">
                                  <input name="product_size" value="{{ $product->product_size }}" class="form-control" type="number" placeholder="Product Size">
                                  <div class="text-danger">
                            ...
                            <div class="form-group row">
                                  ...
                                  <div class="col-md-8">
                                  <input name="product_cost" value="{{ $product->product_cost }}" class="form-control" type="number" placeholder="Product Cost">
                                  <div class="text-danger">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                <input name="product_price" value="{{ $product->product_price }}"  class="form-control" type="number" placeholder="Product Price">
                                <div class="text-danger">
                                ...
                                <div class="tile-footer">
                                  <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                      <button class="btn btn-primary" type="submit" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update Product</button>
                                    </div>
                                  </div>
                                </div>
                              </form>
...
$(document).ready(function(){
  var selectedCategoryId = $("#fk_category_id").val();
  if(selectedCategoryId>=1){
    $.ajax({
      type: "GET",
      url: "{{ url('products/sub_categories/') }}?id="+selectedCategoryId,
