        ...
        <div class="row">
                <div class="col-md-12">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('companies.store') }}" enctype="multipart/form-data">
                              @csrf
                            <div class="tile">
                          <h3 class="tile-title">Company Edit Here</h3>
                          <div class="tile-body">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-md-8">
                                    <input name="email" value="{{ $company->email }}" class="form-control col-md-8" type="email" placeholder="Enter company email address">
                                  </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3">Company Website</label>
                                    <div class="col-md-8">
                                      <input name="website" value="{{ $company->website }}" class="form-control col-md-8" type="text" placeholder="Enter company website address">
                                    </div>
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                  ...
                                  <br>
                                  <img src="{{ asset('assets/company_logo').'/'.$company->company_logo }}" alt="" srcset="" width="50" height="50">
