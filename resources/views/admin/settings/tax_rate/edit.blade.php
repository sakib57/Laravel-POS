...
<main class="app-content">
        ...
        <div class="row">
                <div class="col-md-12">
                        <div class="tile">
                          <h3 class="tile-title">Update Tax rate Here</h3>
                          <div class="tile-body">
                            <form class="form-horizontal" action="{{route('tax-rates.update',$tax->id)}}" method="post">
                              @csrf
                              @method('PUT')
                              ...
                              <div class="row">
                                <div class="col-md-8 col-md-offset-3">
                                  <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update Tax Rate</button>
                                </div>
                              </div>
                          </div>
                            </form>
