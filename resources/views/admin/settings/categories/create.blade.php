...
<main class="app-content">
        ...
        <div class="row">
                <div class="col-md-12">
                        <div class="tile">
                          <a href="{{route('categories.index')}}" class="btn btn-primary" style="float: right;"><i class="fa fa-eye"></i>View Category</a>
                          ...
                          <div class="tile-body">
                            <form class="form-horizontal" method="post" action="{{ route('categories.store') }}">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                    <input name="category_code" class="form-control" type="text" placeholder="Category Code">
