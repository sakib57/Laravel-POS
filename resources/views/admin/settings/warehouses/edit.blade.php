        ...
        <div class="row">
                <div class="col-md-12">
                        <div class="tile">
                          ...
                          <h3 class="tile-title">Update Warehouses Here</h3>
                          <div class="tile-body">
                            <form class="form-horizontal" method="post" action="{{route('warehouses.update',$warehouse->id)}}">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                    <input name="warehouse_code" value="{{$warehouse->warehouse_code}}" class="form-control" type="text" >
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                    <input name="warehouse_name" value="{{$warehouse->warehouse_name}}" class="form-control" type="text" >
                                    </div>
                              </div>
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                      <textarea class="form-control" name="address" rows="5" type="text" >{{$warehouse->address}}</textarea>
                                    </div>
                              </div>
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                    <input name="city" class="form-control" value="{{$warehouse->city}}" type="text" >
                                    </div>
                              </div>
